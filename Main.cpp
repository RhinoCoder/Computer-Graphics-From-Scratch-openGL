...
void DirectionalShadowMapPass(DirectionalLight* light)
{
	...
	auto dss = light->CalculateLightTransform();
	directionalShadowShader.SetDirectionalLightTransform(&dss);
...
void RenderPass(glm::mat4 viewMatrix, glm::mat4 projectionMatrix)
{
	...
	auto sdd = mainLight.CalculateLightTransform();
	shaderList[0].SetDirectionalLightTransform(&sdd);
